...
C_SRCS += \
../HAL/Includes/EEPROM.c \
../HAL/Includes/keypad.c \
../HAL/Includes/lcd.c 

OBJS += \
./HAL/Includes/EEPROM.o \
./HAL/Includes/keypad.o \
./HAL/Includes/lcd.o 

C_DEPS += \
./HAL/Includes/EEPROM.d \
./HAL/Includes/keypad.d \
./HAL/Includes/lcd.d 


# Each subdirectory must supply rules for building sources it contributes
HAL/Includes/EEPROM.o: ../HAL/Includes/EEPROM.c
	arm-none-eabi-gcc -gdwarf-2 "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -DDEBUG -c -I"C:/Users/King 45M/STM32CubeIDE/workspace_1.4.0/DRIVERS/HAL" -I../Inc -I"C:/Users/King 45M/STM32CubeIDE/workspace_1.4.0/DRIVERS/STM32F103C6_DRIVERS/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"HAL/Includes/EEPROM.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
